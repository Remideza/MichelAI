...
MichelAI, music video generator based on [BigGAN](https://github.com/ajbrock/BigGAN-PyTorch), inspired by Mario Klingemann and Mike Tyka works on art using AI
